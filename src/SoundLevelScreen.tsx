...
const SoundLevelScreen = () => {
  ...
  return (
    <View style={styles.highlightBox}>
        ...
        <Text style={styles.highlight}>A package to dynamically measure sound input level in React Native applications. Can be used to help user to adjust microphone sensitivity.</Text>
    </View>
  );
}
